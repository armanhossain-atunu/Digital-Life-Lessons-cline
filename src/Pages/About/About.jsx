...
const About = () => {
    return (
        <div>
            <header className="py-10 mt-17 mb-5 text-center bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                <h1 className="text-3xl md:text-4xl font-bold">About Us</h1>
                <p className="mt-2 text-lg">Digital Life Lessons - Your Personal Growth Companion</p>
            </header>
            <Container>
