...
//             <div className='flex flex-col max-w-md p-6 mt-20 mb-10 rounded-md sm:p-10 bg-base-100  border text-base-900'>
//                 <div className='mb-8 text-center'>
//                     <h1 className='my-3 text-4xl font-bold'>Admin Create User</h1>
...
//                         {loading ? <TbFidgetSpinner className='animate-spin m-auto' /> : 'Create Account'}
//                     </button>
//                 </form>

//                 {/* Google Login */}
//                 <div className='flex items-center hidden pt-4 space-x-1'>
...
//                     className='flex hidden justify-center my-3 items-center space-x-2 border p-2 cursor-pointer'>
//                     <FcGoogle size={32} />
//                     <p>Continue with Google</p>
//                 </div>

//                 <p className='px-6 text-sm hidden text-center text-gray-400'>
