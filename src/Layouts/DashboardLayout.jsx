            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <Link to="/" className="text-2xl font-bold">
                        Digital <span className="text-[#875DF8]">Life Lessons </span> DashBoard
                    </Link>
                </nav>
                {/* Page content here */}
                <Outlet></Outlet>
            ...
            <div className="drawer-side is-drawer-close:overflow-visible">
                ...
                <div className="flex min-h-full flex-col items-start bg-base-200 is-drawer-close:w-14 is-drawer-open:w-64">
                    ...
                    <ul className="menu dash-menu w-full grow">
                        ...
                        {/* Add Lessons item */}
                        <li>
                            <NavLink to="/dashboard/add-lessons">
                                <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Add Lessons">
                                    {/* Add Lessons icon */}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="my-1.5 inline-block size-4"><path d="M12 5v14m-7-7h14"></path></svg>
                        ...
                        <li>
                            <NavLink to="/dashboard/my-lessons">
                                <button className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="My Lessons">
                                    {/* my lessons icon */}
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeLinejoin="round" strokeLinecap="round" strokeWidth="2" fill="none" stroke="currentColor" className="my-1.5 inline-block size-4"><path d="M4 4h16a2 2 0 0 1 2 2v12a2 2 0 0 1 -2 2h-16a2 2 0 0 1 -2 -2v-12a2 2 0 0 1 2 -2z"></path><path d="M8 2v4"></path><path d="M16 2v4"></path><path d="M4 10h16"></path></svg>
